...
The PyTorch implementation of the Weight-Enhanced Feature-based Transformer (WE-FTT), along with all code for data preprocessing, model training, and analysis presented in this study, is publicly available on GitHub at \url{https://github.com/PANXIONG-CN/WE-FTT} under the MIT License.
